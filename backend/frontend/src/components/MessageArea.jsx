...
<RiSendPlane2Fill className='w-[25px] cursor-pointer h-[25px] text-white'/>
    ...
    <h1 className='text-gray-700 font-bold text-[50px]'>Welcome to Private Chat</h1>
    <span className='text-gray-700 font-semibold text-[30px]'>Chat Friendly with privacy  !</span>
      </div>}
